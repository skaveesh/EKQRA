...
$(document).ready(function() {
    ...
    var lsColorKey = "localStorageColorEKQR";
    var modalDiv;
    ...
    (function() {
        ...
        var tr2secondTdElement = document.createElement("td");
        tr2secondTdElement.setAttribute("colspan","20");
        ...
        colorFieldset.setAttribute("title","Hex Colors");

        var colorLegend = document.createElement("legend");
        colorLegend.innerHTML = "Hex Colors";

        colorFieldset.appendChild(colorLegend);

        var colorTable = document.createElement("table");
        colorTable.setAttribute("cellspacing","0");
        colorTable.setAttribute("cellpadding","4");
        colorTable.setAttribute("border","0");

        colorFieldset.appendChild(colorTable);

        var colorTableTBody = document.createElement("tbody");

        colorTable.appendChild(colorTableTBody);

        var tr1color = document.createElement("tr");
        var tr2color = document.createElement("tr");

        var tr1colorFirstTdElement = document.createElement("td");
        var tr2colorFirstTdElement = document.createElement("td");


        tr1color.appendChild(tr1colorFirstTdElement);
        tr2color.appendChild(tr2colorFirstTdElement);

        colorTableTBody.appendChild(tr1color);
        colorTableTBody.appendChild(tr2color);

        colorInputField = document.createElement("input");
        colorInputField.setAttribute("id","colorinputfield");
        colorInputField.setAttribute("class","jscolor");
        colorInputField.setAttribute("value","000000");



        var setColorDiv = document.createElement("div");
        setColorDiv.setAttribute("id","setColorDiv");
        setColorDiv.setAttribute("class","editorButton");
        setColorDiv.setAttribute("style","cursor:pointer; text-align:center; margin-top:3px; margin-bottom:3px");

        var colorDivText = document.createElement("span");
        colorDivText.innerHTML = "SET COLOR";
        colorDivText.setAttribute("style","color:Black; font:bold 13px Arial; cursor:pointer; padding-top:3px; padding-bottom:3px");
        colorDivText.setAttribute("title","Set and Save Color");

        setColorDiv.appendChild(colorDivText);
        ...
        tr1colorFirstTdElement.appendChild(colorInputField);
        tr2colorFirstTdElement.appendChild(setColorDiv);
        ...
        tr2secondTdElement.appendChild(colorFieldset);
        ...
        tr2Element.appendChild(tr2secondTdElement);
        ...
        setColorDiv.addEventListener('click', setColorEvent(), false);
        ...
        //set user color when document load
        if(localStorage.getItem(lsColorKey))
            colorInputField.value = localStorage.getItem(lsColorKey);
    ...
    function setColorEvent(){
        return function(event){
            try{
                surroundSelection("[COLOR=\"" + colorInputField.value + "\"]", "[/COLOR]");
                localStorage.setItem(lsColorKey, colorInputField.value);
            }catch(err){}
        };
    }
